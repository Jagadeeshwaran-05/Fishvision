"""
Generate minimal fish database with only the 31 ML model species
For faster loading in mobile app
"""

import json

# 31 ML Model Species - Complete data
ML_SPECIES = [
    {
        "id": 1,
        "name": "Bangus",
    ...
    },
    {
        ...
        "family": "Cyprinidae",
        "habitat": "Freshwater",
        "native_regions": ["Punjab", "Haryana", "Uttar Pradesh", "Ganges River"],
        "max_length_cm": 146,
        "max_weight_kg": 40.0,
        "max_age_years": 16,
    ...
    },
    {
        ...
        "family": "Siluridae",
        "habitat": "Freshwater",
        "native_regions": ["Ganges", "Brahmaputra", "Godavari", "Rivers throughout India"],
        "max_length_cm": 150,
        "max_weight_kg": 30.0,
        "max_age_years": 20,
    ...
    },
    {
        ...
        "family": "Cyprinidae",
        "habitat": "Freshwater",
        "native_regions": ["Ornamental ponds throughout India"],
        "max_length_cm": 40,
        "max_weight_kg": 3.0,
        "max_age_years": 30,
    ...
    },
    {
        ...
        "family": "Cyprinidae",
        "habitat": "Freshwater",
        "native_regions": ["Throughout India", "Punjab", "Haryana", "Rivers"],
        "max_length_cm": 150,
        "max_weight_kg": 45.0,
        "max_age_years": 11,
    ...
    },
    {
        ...
        "family": "Cichlidae",
        "habitat": "Freshwater",
        "native_regions": ["Aquaculture farms", "Escaped to some rivers"],
        "max_length_cm": 55,
        "max_weight_kg": 2.0,
        "max_age_years": 15,
    ...
    },
    {
        ...
        "family": "Loricariidae",
        "habitat": "Freshwater",
        "native_regions": ["Rivers of Maharashtra", "Tamil Nadu", "Kerala"],
        "max_length_cm": 50,
        "max_weight_kg": 2.5,
        "max_age_years": 20,
    ...
    },
    {
        ...
        "family": "Poeciliidae",
        "habitat": "Freshwater",
        "native_regions": ["Throughout India for mosquito control"],
        "max_length_cm": 7,
        "max_weight_kg": 0.02,
        "max_age_years": 2,
    ...
    },
    {
        ...
        "family": "Pangasiidae",
        "habitat": "Freshwater",
        "native_regions": ["Aquaculture in Andhra Pradesh", "West Bengal"],
        "max_length_cm": 130,
        "max_weight_kg": 44.0,
        "max_age_years": 20,
    ...
    },
    {
        ...
        "family": "Cyprinidae",
        "habitat": "Freshwater",
        "native_regions": ["Aquaculture in several states"],
        "max_length_cm": 35,
        "max_weight_kg": 5.0,
        "max_age_years": 10,
    ...
    },
    {
        ...
        "family": "Cyprinidae",
        "habitat": "Freshwater",
        "native_regions": ["Punjab", "Haryana", "Uttar Pradesh"],
        "max_length_cm": 100,
        "max_weight_kg": 35.0,
        "max_age_years": 9,
    ...
    },
    {
        ...
        "family": "Terapontidae",
        "habitat": "Freshwater",
        "native_regions": ["Limited aquaculture"],
        "max_length_cm": 40,
        "max_weight_kg": 6.0,
        "max_age_years": 26,
    ...
    },
    {
        ...
        "family": "Cichlidae",
        "habitat": "Freshwater",
        "native_regions": ["Throughout India", "Rivers", "Lakes", "Reservoirs"],
        "max_length_cm": 39,
        "max_weight_kg": 1.1,
        "max_age_years": 11,
...
def generate_minimal_database():
    """Generate minimal fish database with only ML model species"""
    print("🐟 Generating minimal fish database (31 ML species only)...")
    
    # Save to file
    output_path = "D:\\Finalllll app\\backend\\data\\fish_db_minimal.json"
    with open(output_path, 'w', encoding='utf-8') as f:
        json.dump(ML_SPECIES, f, indent=2, ensure_ascii=False)
    
    # Calculate size
    import os
    file_size = os.path.getsize(output_path) / 1024  # KB
    
    print(f"\n✅ Minimal database generated!")
    print(f"   Species: {len(ML_SPECIES)}")
    print(f"   File size: {file_size:.1f} KB")
    print(f"   Saved to: {output_path}")
    print(f"\n📋 Next step: Copy to fishclassify/assets/fish_database.json")

if __name__ == "__main__":
    generate_minimal_database()
