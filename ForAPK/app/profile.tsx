...
import { offlineAuthApi } from "../services/offlineStorage";
...
export default function ProfileScreen() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setLoading(true);
        const res = await offlineAuthApi.getCurrentUser();
  ...
  const handleUpdateProfile = async () => {
    try {
      ...
      setLoading(true);
      const res = await offlineAuthApi.updateProfile(payload);
  ...
  const handleChangePassword = async () => {
    try {
      ...
      setLoading(true);
      const res = await offlineAuthApi.updatePassword(
        currentPassword,
        newPassword
      );
      setLoading(false);
  ...
  const handlePickAvatar = async () => {
    try {
      ...
      // For offline: just save the local URI directly
      const res = await offlineAuthApi.updateProfile({
